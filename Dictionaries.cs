...
//// - dictionary are dynamic in size
...
//wordToNumbers.Add("one", 1);
//wordToNumbers.Add("two", 2);
//wordToNumbers.Add("three", 3);
...
//int one = wordToNumbers["one"];
//int two = wordToNumbers["two"];
//int three = wordToNumbers["three"];

//// here is how we set values in a dictionary
//wordToNumbers["one"] = 111;
//wordToNumbers["two"] = 222;

//// wordToNumbers is now:
//// ["one"] = 111
//// ["two"] = 222
//// ["three"] = 3
...
//// we can use the indexer to add or set values => update existing values
